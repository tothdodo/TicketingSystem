...
namespace TicketingSystemDB.Migrations
{
    ...
    [Migration("20230420091500_PlayerAdded")]
            ...
            modelBuilder.Entity("TicketingSystemDB.Entities.Games.Game", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            BuyEnds = new DateTime(2023, 4, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            BuyStarts = new DateTime(2023, 4, 20, 0, 0, 0, 0, DateTimeKind.Local),
                            Opponent = "DEAC",
                            Place = "Arena Savaria",
